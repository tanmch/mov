...
class FirebaseService
{
    ...
    /**
     * Initialization is deferred until Firebase is actually used so that
     * artisan commands and pages that don't touch Firebase still work
     * when the credentials file is absent.
     */
