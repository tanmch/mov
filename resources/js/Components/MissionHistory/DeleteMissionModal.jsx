...
import { X, Trash2, AlertTriangle, Shield, Calendar, MapPin } from 'lucide-react';

export default function DeleteMissionModal({ show, onClose, onConfirm, mission }) {
                            ...
                            <div className="relative overflow-hidden rounded-2xl bg-white/95 backdrop-blur-xl border-2 border-red-200/50 shadow-2xl">
                                ...
                                <div className="relative z-10 p-6 md:p-8">
                                    ...
                                    <div className="text-center mb-6">
                                        ...
                                        >
                                            Apakah Anda yakin ingin menghapus riwayat misi ini?
                                        </motion.p>
                                        ...
                                        {mission && (
                                            <motion.div
                                                ...
                                                className="mt-4 p-4 bg-gray-50 border-2 border-gray-200 rounded-xl text-left space-y-2"
                                            >
                                                <div className="flex items-center gap-2 text-sm">
                                                    <span className="font-semibold text-gray-700">Tipe Misi:</span>
                                                    <span className="text-gray-600">{getMissionTypeLabel(mission.mission_type)}</span>
                                                </div>
                                                {mission.blok_name && (
                                                    <div className="flex items-center gap-2 text-sm">
                                                        <MapPin className="w-4 h-4 text-gray-500" />
                                                        <span className="text-gray-600">{mission.blok_name}</span>
                                                    </div>
                                                )}
                                                {mission.scheduled_at && (
                                                    <div className="flex items-center gap-2 text-sm">
                                                        <Calendar className="w-4 h-4 text-gray-500" />
                                                        <span className="text-gray-600">{formatDateTime(mission.scheduled_at)}</span>
                                                    </div>
                                                )}
                                                {mission.description && (
                                                    <div className="text-sm text-gray-600 italic mt-2 pt-2 border-t border-gray-200">
                                                        "{mission.description}"
                                                    </div>
                                                )}
                                            </motion.div>
                                        ...
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div className="text-left">
                                                ...
                                                <p className="text-xs text-amber-700">
                                                    Riwayat misi yang dihapus tidak dapat dikembalikan. Data ini akan dihapus secara permanen dari sistem.
                                                </p>
                                            </div>
                                        </div>
                                    </motion.div>
                                    ...
                                    >
                                        ...
                                        <span>Tindakan ini akan menghapus riwayat misi secara permanen</span>
                                    </motion.div>
                                </div>
                            </div>
                        </motion.div>
