            ...
            {showText && (
                <div className="flex flex-col relative">
                    <motion.span
                        ...
                        className="relative text-xl md:text-2xl font-black bg-gradient-to-r from-green-600 via-emerald-600 to-green-600 bg-clip-text text-transparent leading-tight"
                    >
                        MOV
                    ...
                    <motion.span
                        ...
                        className="text-[10px] md:text-xs text-gray-600 font-semibold leading-tight hidden md:block bg-gradient-to-r from-gray-600 to-gray-700 bg-clip-text text-transparent"
                    >
                        Smart Farming
                    </motion.span>
                </div>
