...
import { X, Trash2, AlertTriangle, Shield, User, Mail, UserCircle } from 'lucide-react';
                            ...
                            <div className="relative overflow-hidden rounded-2xl bg-white/95 backdrop-blur-xl border-2 border-red-200/50 shadow-2xl">
                                ...
                                <div className="relative z-10 p-6 md:p-8">
                                    ...
                                    <div className="text-center mb-6">
                                        ...
                                        {user && (
                                            <motion.div
                                                ...
                                                className="mt-4 p-4 bg-gray-50 border-2 border-gray-200 rounded-xl text-left space-y-3"
                                            >
                                                ...
                                                <div className="pt-3 border-t border-gray-200 space-y-2">
                                                    <div className="flex items-center justify-between text-sm">
                                                        ...
                                                        <span className="font-semibold text-gray-800 capitalize">
                                                            {user.role === 'k-petani' ? 'K-Petani' : user.role || '-'}
                                                        </span>
                                                    </div>
                                                    {user.username && (
                                                        <div className="flex items-center justify-between text-sm">
                                        ...
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div className="text-left">
                                                ...
                                                <p className="text-xs text-amber-700">
                                                    User yang dihapus tidak dapat dikembalikan. Semua data terkait user ini akan dihapus secara permanen dari sistem.
                                                </p>
                                            </div>
                                        </div>
                                    </motion.div>
                                    ...
                                    >
                                        ...
                                        <span>Tindakan ini akan menghapus user secara permanen</span>
                                    </motion.div>
                                </div>
                            </div>
                        </motion.div>
