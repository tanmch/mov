        ...
        <>
            ...
            <div className="min-h-screen relative overflow-hidden">
                ...
                <motion.header
                    ...
                    className="sticky top-0 z-50 bg-white/95 backdrop-blur-sm border-b-2 border-green-200/50 shadow-sm"
                >
                    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        <div className="flex h-16 items-center justify-between">
                            {/* Logo */}
                            <ApplicationLogo showText={true} asLink={true} href="/" />
                            ...
                            <nav className="flex items-center gap-3">
                                {auth?.user ? (
                                    ...
                                    <>
                                        ...
                                        <Link
                                            href={route('login')}
                                                className="flex items-center gap-2 px-4 py-2 rounded-lg border-2 border-green-600 text-green-600 font-medium hover:bg-green-50 transition-all"
                                        >
                                        ...
                                        <Link
                                            href={route('register')}
                                                className="flex items-center gap-2 px-4 py-2 rounded-lg bg-gradient-to-r from-green-600 to-emerald-600 text-white font-medium hover:from-green-700 hover:to-emerald-700 transition-all shadow-md hover:shadow-lg"
                                        >
