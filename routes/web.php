...
Route::middleware('auth')->group(function () {
    ...
    // Harvest prediction routes
    Route::prefix('/api/predictions')->name('predictions.')->group(function () {
        Route::get('/data', [\App\Http\Controllers\PredictionController::class, 'getPredictionData'])->name('data');
        Route::get('/export/csv', [\App\Http\Controllers\PredictionController::class, 'generateCSV'])->name('export.csv');
    });
